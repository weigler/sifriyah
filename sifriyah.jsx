...
export default function App() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(async () => {
      try {
        const criptografado = await encryptJSON({ livros, emprestimos, pessoas, cobrancas, categorias, tags, config }, senhaAtual);
  ...
  }, [livros, emprestimos, pessoas, cobrancas, categorias, tags, config, loaded, unlocked, senhaAtual, cloudConfig, cloudDocId]);
    ...
    <Section eyebrow="Catálogo" title="Acervo">
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            onAdd({ titulo, autor, paginas, dataAquisicao, capaUrl, valorSemanal, limiteSemanas, categoria, tags: tagsSelecionadas });
            setTitulo("");
            setAutor("");
            setPaginas("");
            setDataAquisicao("");
